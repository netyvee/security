/**
 * SERVICE PAGE — Concierge Security London
...
const images: ServicePageData['images'] = {
  hero:  { src: '/placeholder-image.svg',
            alt: 'Concierge Security London London',
            width: 1200, height: 630, priority: true },
  intro: { src: '/placeholder-image.svg',
            alt: 'Concierge Security London officers Greater London',
  ...
  og:    { src: '/placeholder-image.svg',
            alt: 'Concierge Security London Vigil Security Services',
...
const pageData: ServicePageData = {
  ...
  quickAnswer: 'Vigil Security Services provides concierge security london exclusively to businesses across Greater London. Every officer is directly employed — never agency supplied.',
