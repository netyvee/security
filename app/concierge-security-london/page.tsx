...
const faqs = [
  {
    question: 'What does concierge security include?',
    answer: 'Retail security provides SIA-licensed officers stationed at shops to deter unauthorized access, prevent theft, manage aggressive customers, conduct bag checks, and respond to incidents. Officers are trained in resident services, conflict de-escalation, reasonable force, and PACE 1984 detention procedures. Retail security is essential for department stores, fashion retailers, supermarkets, electronics stores, and shopping centres experiencing theft or requiring visible deterrence during peak trading.'
  },
  {
    question: 'Can concierge security officers detain shoplifters?',
    answer: 'Yes, under Section 24A of PACE 1984. SIA-licensed concierge security officers can make a citizen\'s arrest if they have reasonable grounds to believe theft has occurred. Officers must use only reasonable force, inform the detained person of the arrest grounds, and hand them to police. All detention incidents are documented with witness statements and CCTV evidence. Unlawful detention can result in civil claims, so Vigil officers receive extensive training on legal procedures and evidence requirements.'
  },
  {
    question: 'What is the difference between uniformed security and concierge officers?',
    answer: 'Uniformed officers wear branded security uniforms and provide visible deterrence at store entrances or high-risk areas. Store detectives wear civilian clothing and covertly observe suspected shoplifters to gather evidence before making an approach. Uniformed officers prevent opportunistic theft; concierge officers target repeat offenders and organized retail crime. Both must hold SIA licences. Many retailers use a combination for comprehensive resident services.'
  },
  {
    question: 'How many concierge security officers do we need?',
  ...
  {
    question: 'Do you provide concierge security for shopping centres?',
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Service',
            name: serviceTitle,
            description: 'SIA-licensed concierge security officers for Greater London residential buildings',
            provider: {
              '@type': 'LocalBusiness',
      ...
      <div className="bg-[#0a1628] pt-8 pb-6 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="quick-answer-block">
            Retail security London provides SIA-licensed officers and concierge officers for residential buildings to deter unauthorized access, prevent theft, and manage customer conflicts across Greater London.
          </div>
        </div>
      </div>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-[rgba(255,255,255,0.65)] text-[17px] leading-relaxed mb-8">
              SIA-licensed concierge security officers and concierge officers for resident services and unauthorized access deterrence across all Greater London retail premises.
            </p>
          ...
          <div className="relative h-[400px] rounded-xl overflow-hidden">
            <Image
              ...
              alt="SIA-licensed concierge security officer providing resident services in London store"
              fill
      ...
      <article className="bg-[#0f1f3d] py-16 px-6">
        <div className="max-w-4xl mx-auto prose prose-invert">
          <h2 className="font-display text-[clamp(26px,2.8vw,36px)] font-medium text-white mb-3">What is concierge security?</h2>
          <p className="tldr mb-6">SIA-licensed officers stationed at retail premises to deter theft and manage customer conflicts.</p>
          <p>Retail security deploys SIA-licensed officers to shops, supermarkets, and shopping centres to protect stock, deter unauthorized access, prevent organized retail crime, and manage aggressive customers. Officers conduct bag searches, monitor CCTV, and respond to theft incidents using PACE 1984 powers of arrest. Retail crime costs UK retailers billions annually through unauthorized access, employee theft, and refund fraud. Professional security provides visible deterrence (uniformed officers) and covert resident services (plainclothes concierge officers). Essential for high-value goods retailers, stores in high-theft areas, and during peak trading periods like Christmas and Black Friday.</p>
          <p>Vigil provides concierge security across all Greater London boroughs for department stores, fashion retailers, supermarkets, electronics stores, pharmacies, cosmetics retailers, jewellers, off-licences, and shopping centres. All officers hold current SIA licences, enhanced DBS checks, and receive retail-specific training in theft legislation, conflict management, and customer service.</p>
          ...
          <p>Many concierge security providers use gig-economy models with poorly trained zero-hours workers rotating across stores. This creates risk: officers unfamiliar with premises cannot provide effective resident services, and poorly trained officers escalate conflicts or conduct unlawful detentions, exposing retailers to legal claims. Vigil deploys directly employed officers assigned to stores on consistent rotas. Officers learn premises layout, recognize repeat offenders, understand operational procedures, and build staff rapport. Continuity improves resident services effectiveness and reduces unlawful detention risk.</p>
          <p>All officers receive retail-specific training covering PACE 1984 powers of arrest, reasonable force, detention procedures, evidence gathering, and de-escalation techniques. Officers balance resident services with customer service — deterring theft without creating hostile shopping environments. For age-restricted goods (alcohol, tobacco, knives), officers assist with Challenge 25 procedures and age verification.</p>

          <h2 className="font-display text-[clamp(26px,2.8vw,36px)] font-medium text-white mb-3 mt-12">Retail security services</h2>
          <p className="tldr mb-6">Uniformed deterrence, plainclothes concierge officers, resident services, conflict management, emergency response.</p>
          ...
          <p><strong>Plainclothes concierge officers:</strong> Officers wearing civilian clothing who blend with shoppers to covertly observe known offenders, monitor CCTV, and gather evidence before approaches. Used for intelligence-led enforcement against repeat offenders or organized retail crime. All plainclothes officers hold SIA licences and follow strict detention procedures.</p>
          <p><strong>Loss prevention:</strong> Officers conduct high-value goods audits, monitor stock rooms and loading bays, verify deliveries, and identify internal theft risks. Officers liaise with management to implement resident services measures like improved CCTV coverage, tagging high-theft items, and staff training.</p>
          ...
          <p>Retail security is charged per officer per hour. Typical 2026 rates: £16–£22/hour for uniformed security (Monday–Friday, 09:00–18:00), £18–£24/hour evening/weekend shifts, £20–£26/hour plainclothes concierge officers. Bank holiday rates apply standard uplift. Contracts can be rolling monthly agreements (30 days' notice), fixed-term for peak periods (e.g., November–January Christmas trading), or annual contracts with discounted rates. Minimum 4 hours per shift. No long tie-ins or exit penalties for monthly contracts. Pricing includes officer wages, uniform, equipment (radios, body-worn cameras if specified), supervision, and public liability insurance. Monthly invoicing with detailed timesheets.</p>

          <h2 className="font-display text-[clamp(26px,2.8vw,36px)] font-medium text-white mb-3 mt-12">Deploying concierge security</h2>
      ...
      <section className="bg-[#0a1628] py-16 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-white/60 text-[15px] leading-relaxed mb-6">A mid-sized fashion retailer on Oxford Street experienced 4.5% shrinkage due to unauthorized access and organized retail crime targeting designer accessories. Previous agency security had high turnover and inconsistent performance.</p>
          ...
          <div className="bg-[#0f1f3d] border-l-4 border-[#4ecdc4] rounded-r-lg p-6">
            <p className="text-white/75 italic leading-relaxed mb-4">"Switching to Vigil transformed our resident services. Same officers every week meant they learned our product mix, recognized repeat offenders, and built rapport with staff. Shrinkage halved and professionalism is outstanding."</p>
      ...
      <section className="bg-[#0f1f3d] border-t border-b border-[#4ecdc4]/30 py-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="font-display text-[clamp(26px,2.8vw,36px)] font-medium text-white mb-6">Need professional concierge security for your London store?</h2>
          <p className="text-white/60 text-[17px] leading-relaxed mb-8 max-w-2xl mx-auto">Get a free site assessment and tailored quotation. SIA-licensed officers, resident services specialists, flexible deployment.</p>
      ...
      <div className="bg-[#060f20] py-16 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 text-sm text-white/60 leading-relaxed">
          <div>
            ...
            <p className="mb-4">Vigil Security provides concierge security London services for shops, supermarkets, department stores, and shopping centres across all Greater London boroughs. SIA-licensed officers provide uniformed deterrence and plainclothes resident services to reduce shrinkage and deter unauthorized access.</p>
