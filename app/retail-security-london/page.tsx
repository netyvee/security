...
const faqs = [
  {
    question: 'What does retail security include?',
    answer: 'Retail security provides SIA-licensed officers stationed at shops to deter shoplifting, prevent theft, manage aggressive customers, conduct bag checks, and respond to incidents. Officers are trained in loss prevention, conflict de-escalation, reasonable force, and PACE 1984 detention procedures. Retail security is essential for department stores, fashion retailers, supermarkets, electronics stores, and shopping centres experiencing theft or requiring visible deterrence during peak trading.'
  },
  {
    question: 'Can retail security officers detain shoplifters?',
    answer: 'Yes, under Section 24A of PACE 1984. SIA-licensed retail security officers can make a citizen\'s arrest if they have reasonable grounds to believe theft has occurred. Officers must use only reasonable force, inform the detained person of the arrest grounds, and hand them to police. All detention incidents are documented with witness statements and CCTV evidence. Unlawful detention can result in civil claims, so Vigil officers receive extensive training on legal procedures and evidence requirements.'
  },
  {
    question: 'What is the difference between uniformed security and store detectives?',
    answer: 'Uniformed officers wear branded security uniforms and provide visible deterrence at store entrances or high-risk areas. Store detectives wear civilian clothing and covertly observe suspected shoplifters to gather evidence before making an approach. Uniformed officers prevent opportunistic theft; store detectives target repeat offenders and organized retail crime. Both must hold SIA licences. Many retailers use a combination for comprehensive loss prevention.'
  },
  {
    question: 'How many retail security officers do we need?',
  ...
  {
    question: 'Do you provide retail security for shopping centres?',
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Service',
            name: serviceTitle,
            description: 'SIA-licensed retail security officers for Greater London shops and shopping centres',
            provider: {
              '@type': 'LocalBusiness',
      ...
      <div className="bg-[#0a1628] pt-8 pb-6 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="quick-answer-block">
            Retail security London provides SIA-licensed officers and store detectives for shops and shopping centres to deter shoplifting, prevent theft, and manage customer conflicts across Greater London.
          </div>
        </div>
      </div>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-[rgba(255,255,255,0.65)] text-[17px] leading-relaxed mb-8">
              SIA-licensed retail security officers and store detectives for loss prevention and shoplifting deterrence across all Greater London retail premises.
            </p>
          ...
          <div className="relative h-[400px] rounded-xl overflow-hidden">
            <Image
              src="https://res.cloudinary.com/duhicmygg/image/fetch/w_1200,f_auto,q_auto/https://security.vigilservices.co.uk/wp-content/uploads/2025/08/retail-store-security-london.png"
              alt="SIA-licensed retail security officer providing loss prevention at London retail premises — Vigil Security Services"
              fill
      ...
      <article className="bg-[#0f1f3d] py-16 px-6">
        <div className="max-w-4xl mx-auto prose prose-invert">
          ...
          <p className="tldr mb-6">Uniformed deterrence, plainclothes store detectives, loss prevention, conflict management, emergency response.</p>
          ...
          <p>Retail security is charged per officer per hour. Typical 2026 rates: £16–£22/hour for uniformed security (Monday–Friday, 09:00–18:00), £18–£24/hour evening/weekend shifts, £20–£26/hour plainclothes store detectives. Bank holiday rates apply standard uplift. Contracts can be rolling monthly agreements (30 days' notice), fixed-term for peak periods (e.g., November–January Christmas trading), or annual contracts with discounted rates. Minimum 4 hours per shift. No long tie-ins or exit penalties for monthly contracts. Pricing includes officer wages, uniform, equipment (radios, body-worn cameras if specified), supervision, and public liability insurance. Monthly invoicing with detailed timesheets.</p>

          <h2 className="font-display text-[clamp(26px,2.8vw,36px)] font-medium text-white mb-3 mt-12">Deploying retail security</h2>
      ...
      <section className="bg-[#0a1628] py-16 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-white/60 text-[15px] leading-relaxed mb-6">A mid-sized fashion retailer on Oxford Street experienced 4.5% shrinkage due to shoplifting and organized retail crime targeting designer accessories. Previous agency security had high turnover and inconsistent performance.</p>
      ...
      <section className="bg-[#0f1f3d] border-t border-b border-[#4ecdc4]/30 py-16 px-6">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="font-display text-[clamp(26px,2.8vw,36px)] font-medium text-white mb-6">Need professional retail security for your London store?</h2>
      ...
      <div className="bg-[#060f20] py-16 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 text-sm text-white/60 leading-relaxed">
          <div>
            ...
            <p className="mb-4">Vigil Security provides retail security London services for shops, supermarkets, department stores, and shopping centres across all Greater London boroughs. SIA-licensed officers provide uniformed deterrence and plainclothes loss prevention to reduce shrinkage and deter shoplifting.</p>
